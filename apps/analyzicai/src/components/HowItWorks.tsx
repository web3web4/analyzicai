      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-10 left-[8%] right-[8%] z-0" aria-hidden="true">
            <div className="h-[1px] bg-gradient-to-r from-cyan via-magenta to-cyan opacity-40" />
            {/* Travelling pulse */}
            <div
              className="absolute top-0 left-0 w-24 h-[1px] bg-gradient-to-r from-transparent via-cyan to-transparent animate-scan-line opacity-80"
            />
          </div>
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    ...
                    <div
                      className={`relative z-20 w-20 h-20 flex items-center justify-center border mb-6 transition-all ${
                        isCyan
                          ? 'border-cyan/30 bg-surface-700'
                          : 'border-magenta/30 bg-surface-700'
                      }`}
                    >
                      <step.icon className={`w-9 h-9 ${isCyan ? 'text-cyan' : 'text-magenta'}`} />
        ...
        <ScrollReveal delay={0.3} className="mt-10">
          <div className="p-8 bg-surface-700/50 border-l-2 border-cyan">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex-shrink-0">
                <div className="flex items-center space-x-2 px-6 py-3 border border-magenta/30 bg-magenta/[0.06] font-mono text-sm">
                  <Sparkles className="w-5 h-5 text-magenta" />
                  <span className="font-bold text-magenta">3-Step Validation</span>
                </div>
              </div>
            </div>
          </div>

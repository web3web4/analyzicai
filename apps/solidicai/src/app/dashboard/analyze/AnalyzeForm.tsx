...
import { createBrowserClient, useApiKeyAccess, NoApiKeysPrompt, ApiKeysPromptCard, useProviderSelection } from "@web3web4/shared-platform";
import {
  Logo,
...
export function AnalyzeForm() {
  ...
  const {
    ...
    toggleProvider: toggleProviderInternal,
    handleMasterChange: handleMasterChangeInternal,
    handleModelTierChange: handleModelTierChangeInternal,
    handleMasterModelTierChange: handleMasterModelTierChangeInternal,
  ...
  // Wrapper functions to convert string to AIProvider type
  function toggleProvider(providerId: string) {
    toggleProviderInternal(providerId as AIProvider);
  }

  function handleMasterChange(providerId: string) {
    handleMasterChangeInternal(providerId as AIProvider);
  }

  function handleModelTierChange(providerId: string, tier: string) {
    handleModelTierChangeInternal(providerId as AIProvider, tier as ModelTier);
  }

  function handleMasterModelTierChange(tier: string) {
    handleMasterModelTierChangeInternal(tier as ModelTier);
  }
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      {(error || providerError) && (
        <div className="mb-6 bg-red-500/10 border border-red-500/20 text-red-400 px-4 py-3 rounded-xl flex items-center gap-3 text-sm  mx-auto">
      ...
      {/* 1. Contract Input */}
      <GlassCard className="mx-auto mb-8">
      ...
      <GlassCard className="mx-auto mb-8">
        ...
        <ProviderSelector
          ...
          onMasterModelTierChange={handleMasterModelTierChange}
      ...
      <ApiKeysPromptCard accentColor="cyan" className="mx-auto mb-8" />

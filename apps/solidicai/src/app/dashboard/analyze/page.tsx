...
import { createBrowserClient, useApiKeyAccess, NoApiKeysPrompt, ApiKeysPromptCard } from "@web3web4/shared-platform";
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-cyan-500/30">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <ApiKeysPromptCard accentColor="cyan" className="max-w-3xl mx-auto mb-8" />

...
export function Logo({
  ...
  const prefixColor = isSolidic ? "text-[#00FFD1]" : isAnalyzic ? "text-white" : "text-[#FF2D9E]";

  return (
    <div className={`flex items-center ${classes.gap} ${className}`}>
      <svg width={classes.icon} height={classes.icon} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none" className="shrink-0">
